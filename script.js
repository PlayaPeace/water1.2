    ...
    inputs[elem].addEventListener('keydown', function (event) {
        if (event.key === 'Enter') {
            ...
            if (hGeom && hIlInput && hSSum && hL) {
                ...
                let text = Number(hGeom.toFixed(1)) + " + " + hIlInput + " + 20 + " + Number(hSSum.toFixed(3)) + " + 0 + " + Number(hL.toFixed(3)) + " = " + hTr;
